...
# 處理文本並生成關鍵字
text = read_file("YunTech2025/套檢測試/colab文件/測試文案.txt")
tags = extract_keywords(text, dict_path="YunTech2025/套檢測試/colab文件/dict (1).txt", stop_path="YunTech2025/套檢測試/colab文件/stopwords (1).txt")
...
# 生成詞雲
generate_wordcloud(freq, "YunTech2025/套檢測試/colab文件/goblin.jpg", "YunTech2025/套檢測試/colab文件/Iansui/Iansui-Regular.ttf")
